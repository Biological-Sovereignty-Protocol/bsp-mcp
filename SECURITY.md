...
### In Scope
- Consent verification bypass in MCP tool handlers
- Authentication and authorization in MCP server endpoints
- ConsentToken validation logic
- Data exposure through MCP tool responses
- Smart contract interaction security (BEORegistry, IEORegistry, AccessControl, DomainRegistry)
